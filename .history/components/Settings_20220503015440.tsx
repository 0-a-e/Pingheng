...
import {Text, ToastAndroid, TouchableOpacity, View,NativeModules, ScrollView,Image, Dimensions, useWindowDimensions} from 'react-native';
import Icon from 'react-native-vector-icons/Feather';
import logout from '../data/logout';
import getMeta,{setnewMeta,getserverURL} from '../data/Getmeta';
import Modal, {ModalContent,BottomModal,SlideAnimation } from 'react-native-modals';
...
const setnewEmoji = async () => {
    ...
    return(
		...
		<TouchableOpacity
            style={{width:'90%', borderBottomWidth:0.5,borderColor:"#202020",borderTopStartRadius:20,borderTopEndRadius:20,backgroundColor:"rgb(31,34,42)",height:80,alignItems: 'center',justifyContent: 'center',flexDirection:"row"}}
		...
		<View style={{width:"100%",flexDirection: 'row',alignContent:"center",justifyContent:"center"}}>
		<TouchableOpacity
            style={{width:'90%', borderTopWidth:0.5,borderColor:"#202020",borderBottomEndRadius:20,borderBottomStartRadius:20, backgroundColor:"rgb(31,34,42)",height:80,alignItems: 'center',justifyContent: 'center',flexDirection:"row"}}
...
{/*		<Modal
  ...
  <Modal
	...
	modalAnimation={new SlideAnimation({
	  ...
	  width={1}
	  height={1}
	  modalStyle={{borderRadius:20,marginBottom:20,backgroundColor:"transparent",padding:0,margin:0}}
	  containerStyle={{padding:0,margin:0}}
  >
    <ModalContent style={{margin:0,padding:0}}>
		<View style={{backgroundColor:"transparent",width:"100%",height:useWindowDimensions().height - 380}} onTouchStart={() => setserverinfovisible(false)}></View>
		<View style={{backgroundColor:"rgb(255,255,255)",width:"100%",borderRadius:20,height:345,paddingLeft:10,paddingRight:10,paddingTop:10,paddingBottom:10}}>
		{meta &&
		<>
